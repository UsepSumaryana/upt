...
<body>
                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="asset/img/avatar5.png" class="nav-avatar" />
                        ...
                        <div class="module">
							...
							<div class="module-body">
                               <div class=" clearfix">
                                   ...
                                   <div class="pull-left">
                                        <a href="#" class="btn btn-info"><i class="icon-eye-open">&nbsp; lihat</i></a>
                                    </div>
                                       </form>
                                </div>
                                <hr>
    ...
    <div class="container">
      ...
      <b class="copyright">&copy; 2018 SMKN 4 Bandung </b> All rights reserved.
    </div>
  </div>
